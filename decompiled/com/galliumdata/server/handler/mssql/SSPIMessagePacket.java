...
public class SSPIMessagePacket
extends MSSQLPacket {
    private byte[] data;

    public SSPIMessagePacket(ConnectionState connectionState) {
        super(connectionState);
        this.typeCode = (byte)17;
    }
    ...
    public boolean removeMember(String key) {
        throw new ServerException("db.mssql.logic.CannotRemoveMember", key, "SSPI packet");
    }
}
